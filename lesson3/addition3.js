...
//     document.write(`<h4>${user.userId}</h4>`);
...
// for (let info of usersList) {
//     document.write(`<div class="user-block">`);
//     document.write(`<h2>${info.id} - ${info.name} - ${info.username}</h2>`);
//     document.write(`<h3>${info.email} - ${info.phone}</h3>`);
//     document.write(`<div class="address-block">`);
//     document.write(`<p>City - ${info.address.city}</p>`);
//     document.write(`<p>Street - ${info.address.street}</p>`);
//     document.write(`<p>Suite - ${info.address.suite}</p>`);
//     document.write(`<p>Zip code - ${info.address.zipcode}</p>`);
//     document.write(`</div>`);
//     document.write(`</div>`);
// }
// document.write(`</div>`);
...
// let newMassiv = [];
// for (i = 0; i <20; i++) {
//         console.log(Math.random(newMassiv));
//     }

// let newMassiv = [];
// for (i = 0; i <20; i++) {
//     console.log(Math.round(Math.random(newMassiv) * 731)+8);
// }
...
// all = numbers[0] + numbers[1] + numbers[2] + numbers[3] + numbers[4] + numbers[5] + numbers[6];
// let avarageValue = all / 7;
...
// let elements = [2,3,4,8,5,4,6,5];
// for (h = 0; h < 8; h++) {
//     newElements = elements[h] * 5;
